...
public class WorldCommunityCMD implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        String worldName = Helpers.COMMUNITY_WORLD;
        ...
        WorldManagerFunctions.communityWorldTeleport(safeLoc.getX(), safeLoc.getY(), safeLoc.getZ(), player);
        player.sendMessage(Text.of(TextColors.WHITE, "[SPW] ", TextColors.YELLOW, "You have been teleported into the community world."));
